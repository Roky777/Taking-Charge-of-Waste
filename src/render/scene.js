...
function createBin(bin, itemName, state) {
  ...
  // Category art and text stay separate so replacement bin artwork can be
  // dropped in later without changing the level data.
  ...
  const categoryIcon = art(bin.art, "sorting-bin__category-icon", bin.assetSet);
  root.append(categoryIcon);
