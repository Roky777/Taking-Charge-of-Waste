...
import { assets, hydrateDeferredImages, preloadImage, preloadLevelAssets } from "./data/assets.js?v=20260923-content-audit-1";
...
const game = createGame({ persistProgress: !isDebugLaunch, gameId: "Taking-Charge-of-Waste" });
let sparky;
let successDance;
