...
export function renderGameUi(state, level) {
  ...
  if (state.screen === "complete") {
    ...
    screen.setAttribute("aria-label", "Waste Sorting Master certificate");
    ...
    card.innerHTML = `
      ...
      <p class="game-certificate__eyebrow">Clean Planet Champion</p>
      <h2>Waste Sorting <em>Master!</em></h2>
      <p class="game-certificate__subtitle">Sorting challenge complete!</p>
      ...
      <div class="game-certificate__stamps" aria-label="Skills mastered">
        <div class="game-certificate__stamp game-certificate__stamp--shapes"><i aria-hidden="true">🌿</i><strong>Green</strong></div>
        <div class="game-certificate__stamp game-certificate__stamp--families"><i aria-hidden="true">♻</i><strong>Sort</strong></div>
        <div class="game-certificate__stamp game-certificate__stamp--motion"><i aria-hidden="true">💧</i><strong>Blue</strong></div>
      </div>
  ...
  if (state.completedLevel) {
    ...
    success.innerHTML = `
      <img class="success-screen__background" src="assets/backgrounds/taking_charge_of_waste_bg_blurred.webp" alt="" />
  ...
  if (state.paused) {
    ...
    pause.innerHTML = `
      <img class="pause-screen__background" src="assets/backgrounds/taking_charge_of_waste_bg_blurred.webp" alt="" />
