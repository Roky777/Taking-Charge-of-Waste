...
export function createGame({ persistProgress = true, gameId = "Taking-Charge-of-Waste" } = {}) {
  ...
  function choose(itemId, category) {
    ...
    state.feedback = {
      type: "wrong",
      message: mastery.wrong >= 3 ? "Try the glowing box −10" : mastery.wrong >= 2 ? "Look at the food clue −10" : "Try again! −10",
      category,
    };
    sounds.retry();
